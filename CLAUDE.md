...
- `src-tauri/src/commands/system.rs` — exit_app, is_onboarding_done, set_onboarding_done (NSIS update persistence)
...
- `src/components/layout/AppShell.tsx` — onboarding recovery from filesystem marker
...
## Test Suite: 1443 tests, 0 failures (50 test files)
